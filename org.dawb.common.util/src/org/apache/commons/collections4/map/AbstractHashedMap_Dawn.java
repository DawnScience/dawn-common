 ...
 */
public class AbstractHashedMap_Dawn<K, V> extends AbstractMap<K, V> implements
		IterableMap<K, V> {
	 ...
	 */
	protected AbstractHashedMap_Dawn() {
		super();
	}
	...
	protected AbstractHashedMap_Dawn(final int initialCapacity,
			final float loadFactor, final int threshold) {
		super();
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AbstractHashedMap_Dawn(int initialCapacity,
	 ...
	 *             if the map is null
	 */
	protected AbstractHashedMap_Dawn(final Map<? extends K, ? extends V> map) {
	 ...
	 * {@link #put(Object, Object)}.
	 * <p>
	 * It is private to allow the constructor to still call it even when putAll
	 * is overriden.
	 * 
	 * @param map
	 *            the map to add
	 ...
	 *            the value to add
	 */
	protected void reuseEntry(final HashEntry<K, V> entry, final int hashIndex,
	 ...
	 *            the value to add
	 */
	protected void addMapping(final int hashIndex, final int hashCode,
	 ...
	 */
	protected HashEntry<K, V> createEntry(final HashEntry<K, V> next,
			final int hashCode, final K key, final V value) {
	 ...
	 *            the previous entry in the chain
	 */
	protected void removeEntry(final HashEntry<K, V> entry,
			final int hashIndex, final HashEntry<K, V> previous) {
		if (previous == null) {
	...
	protected static class HashMapIterator<K, V> extends HashIterator<K, V>
		...
		protected HashMapIterator(final AbstractHashedMap_Dawn<K, V> parent) {
			super(parent);
		}
	...
	protected static class EntrySet<K, V> extends AbstractSet<Map.Entry<K, V>> {
		/** The parent map */
		private final AbstractHashedMap_Dawn<K, V> parent;

		protected EntrySet(final AbstractHashedMap_Dawn<K, V> parent) {
			super();
			this.parent = parent;
		}
	...
	protected static class EntrySetIterator<K, V> extends HashIterator<K, V>
		...
		protected EntrySetIterator(final AbstractHashedMap_Dawn<K, V> parent) {
			super(parent);
		}
	...
	protected static class KeySet<K> extends AbstractSet<K> {
		/** The parent map */
		private final AbstractHashedMap_Dawn<K, ?> parent;

		protected KeySet(final AbstractHashedMap_Dawn<K, ?> parent) {
			super();
			this.parent = parent;
		}
	...
	protected static class KeySetIterator<K> extends HashIterator<K, Object>
		...
		@SuppressWarnings("unchecked")
		protected KeySetIterator(final AbstractHashedMap_Dawn<K, ?> parent) {
			super((AbstractHashedMap_Dawn<K, Object>) parent);
		}
	...
	protected static class Values<V> extends AbstractCollection<V> {
		/** The parent map */
		private final AbstractHashedMap_Dawn<?, V> parent;

		protected Values(final AbstractHashedMap_Dawn<?, V> parent) {
			super();
			this.parent = parent;
		}
	...
	protected static class ValuesIterator<V> extends HashIterator<Object, V>
		...
		@SuppressWarnings("unchecked")
		protected ValuesIterator(final AbstractHashedMap_Dawn<?, V> parent) {
			super((AbstractHashedMap_Dawn<Object, V>) parent);
		}
	...
	protected static abstract class HashIterator<K, V> {
		...
		protected HashIterator(final AbstractHashedMap_Dawn<K, V> parent) {
			super();
			this.parent = parent;
	...
	@Override
	@SuppressWarnings("unchecked")
	protected AbstractHashedMap_Dawn<K, V> clone() {
		try {
			final AbstractHashedMap_Dawn<K, V> cloned = (AbstractHashedMap_Dawn<K, V>) super
					.clone();
