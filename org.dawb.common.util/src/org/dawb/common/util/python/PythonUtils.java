 ...
 */ 
package org.dawb.common.util.python;
 ...
 *   @author gerring
 *   @date Jul 29, 2010
 *   @project org.dawb.common.python
 **/
public class PythonUtils {
	...
	/**
	 * Could not find Java method to search path, so since it is not hard,
	 * will write a simple algorithm.
	 * 
	 * @param path
	 * @param execName
	 * @return
	...
	public static void main(String[] args) {
		System.out.println(isLegalName("fred"));
		System.out.println(isLegalName("fred_"));
		System.out.println(isLegalName("fred_1"));
		System.out.println(isLegalName("fred_1 r"));
		System.out.println(isLegalName("fred_1 *"));
		System.out.println(isLegalName("&fred_1"));
		System.out.println(isLegalName("fred&1"));
	}
	...
	/**
	 * Attempts to guess a python interpreter command to use when
	 * linking to python with RPC.
	 * 
	 * @return
	 */
	public static String getPythonInterpreterCommand() {
		...
		return "python"; // make sure python is on the path and has numpy please.
	}
