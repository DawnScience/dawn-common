...
public class ExampleBinaryOps {
	...
	public static void runExample() throws Throwable {
		...
		IDataset visualLabel = ConvertIDataset.grayToIDataset(label, contours.size());
		IDataset visualContour = ConvertIDataset.renderContours(contours, colorExternal, colorInternal, input.width, input.height);
