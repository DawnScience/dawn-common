...
//	the pluginPath
	...
	private Map<String, Map<String, Map<String, Object>>> parameters = new HashMap<>();

	public Map<String, Map<String, Map<String, Object>>> getParameters() {
		return parameters;
	}

	public void setParameters(Map<String, Map<String, Map<String, Object>>> parameters) {
