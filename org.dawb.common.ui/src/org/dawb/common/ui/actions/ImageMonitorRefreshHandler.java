 ...
 *
 */
public class ImageMonitorRefreshHandler extends AbstractHandler {

    private static final Logger logger = LoggerFactory.getLogger(ImageMonitorRefreshHandler.class);
