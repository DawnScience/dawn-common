 ...
 *
 */
public class ImageMonitorOpenLinkedHandler extends AbstractHandler {

    private static final Logger logger = LoggerFactory.getLogger(ImageMonitorOpenLinkedHandler.class);
