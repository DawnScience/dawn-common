...
public class DawbResourcePage extends WizardDataTransferPage {
	...
	protected DawbResourcePage(final String name, 
	...
	private void dialogChanged() {
		...
		if (choice == RESOURCE_CHOICE.PROJECT_AND_NAME) {
			...
			if (!seqName.endsWith(FileUtils.getFileExtension(defaultName))) {
				updateStatus("The sequence name must end with '"+FileUtils.getFileExtension(defaultName)+"'");
				return;
			}
