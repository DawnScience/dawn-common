...
/*******************************************************************************
 * Copyright (c) 2010-2016 Compart AG and others.
 ...
 *     Diamond Light Source - Baha El Kassaby - Use Grid data for label tooltip
 *******************************************************************************/
...
public class TooltipCCombo extends CCombo
{
    ...
    private class TooltipHandler implements MouseMoveListener, SelectionListener, MouseTrackListener
    {
         ...
         * @param index the item which is currently elected/hovered
         */
    ...
    private class WrapTooltip extends org.eclipse.jface.window.ToolTip
    {
        ...
        protected Composite createToolTipContentArea(Event event, Composite parent)
            ...
            this.label = new Label(composite, SWT.WRAP | SWT.LEFT);
